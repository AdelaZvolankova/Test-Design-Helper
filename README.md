...
There are currently 2 test environments available: test and prod. Tests are running against prod by default. You can change it to test by adding `--variable environment:test` to run command.
