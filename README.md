...
There are currently 2 test environments: test and prod. Tests are running against prod by default. 
You can change it by running adding `--variable environment:test` to run command.
